...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x10 */	IDEXW(G2E,adc,1), EMPTY, EMPTY, IDEX(E2G,adc),
  ...
  /* 0x3c */	IDEXW(I2a,cmp,1), IDEX(I2a,cmp), IDEXW(notrack, notrack, 6), EMPTY,
  ...
  /* 0x68 */	IDEX(I, push), IDEX(I_E2G,imul3), IDEXW(push_SI,push,1), IDEXW(I_E2G,imul3,1),
  ...
  /* 0xf0 */	EMPTY, EMPTY, EMPTY, IDEXW(endbr, endbr, 3),
...
/*2 byte_opcode_table */
  ...
  /* 0x80 */	EMPTY, EMPTY, IDEX(J,jcc), IDEX(J,jcc),
